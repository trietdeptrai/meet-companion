...
const pipelineStages = [
  { id: "INPUT_INTAKE", label: "Intake" },
  { id: "CONCEPT_UNDERSTANDING", label: "Understand" },
  { id: "KNOWLEDGE_DECOMPOSITION", label: "Decompose" },
  { id: "TREATMENT_CANDIDATES", label: "Treatments" },
  { id: "TREATMENT_RANKING", label: "Rank" },
  { id: "CREATIVE_BRIEF", label: "Brief" },
  { id: "STORYBOARD_SHOTLIST", label: "Shots" },
  { id: "MOTION_COMPONENT_GRAPH", label: "Graph" },
  { id: "TIMELINE_COMPILER", label: "Timeline" },
  { id: "RENDERER_ALLOCATION", label: "Renderer" },
  { id: "STATIC_PREFLIGHT", label: "Preflight" },
  { id: "PREVIEW_RENDER", label: "Preview" },
  { id: "FRAME_SAMPLING_QA", label: "QA" },
  { id: "REPAIR_POLISH", label: "Polish" },
  { id: "FINAL_RENDER", label: "Final" },
